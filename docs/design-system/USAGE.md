...
- Do not use Stitch-hosted images, fake client names, fake metrics, or placeholder social links as production content. Metric-style content is allowed only when explicitly approved in the site content source of truth, such as the hero popup recorded in `docs/site-content/sections/hero.md`.
