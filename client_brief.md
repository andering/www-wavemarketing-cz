**ÚVODNÍ STRÁNKA: ( LOGO vlevo nahoře)**

**Nabídka v liště: 1. Úvod**

**2\. Naše služby**

**3\. Reference ( zatím budou prázdné, nebo bych je tam přidala, až to více rozjedeme)**
...
- **Cenová poznámka:** Ceny jsou individuální dle specifikací a požadavků každého klienta. Rádi vám vše naceníme na míru. Ceny jsou uvedeny bez DPH.
- **Jak probíhá spolupráce (Timeline/Kroky):**
  ...
  - **Návrh řešení:** Připravíme strategii na míru.
  - **Realizace a péče:** Spustíme kampaně a pravidelně s vámi komunikujeme. Průběžně optimalizujeme a radujeme se ze společných úspěchů.

## **3\. Reference ( zatím ale nemůžeme použít )**

- **Hlavní nadpis (H1):** _Vlny, které jsme úspěšně sjeli. Příběhy našich klientů._
- **Úvodní text:** Největší odměnou pro nás nejsou jen rostoucí grafy, ale spokojení klienti, se kterými budujeme dlouhodobá partnerství. Podívejte se, komu už jsme pomohli růst.
- **Případové studie (Case Studies):** U každé reference zachovat strukturu:
  - **Klient a jeho výzva:** Co klient řešil, když k nám přišel (např. _Ztráceli se v online světě a nevěděli, jak komunikovat_).
  - **Naše řešení (Jak jsme se naladili):** Co jsme vymysleli a udělali.
  - **Výsledek:** Konkrétní čísla (růst tržeb, dosah) + **Zlatý hřeb:** Citát klienta, který chválí vaši péči, lidský přístup a spolehlivost.
- **Logo wall (Zeď log klientů):** Rychlý vizuální přehled značek, které vám důvěřují.
...
- **Kontaktní údaje:**
  ...
  - **Napište nám:** \[ [jana.skalnikova@wavemarketing.cz](mailto:jana.skalnikova@wavemarketing.cz) \]
  - **Kde se můžeme vidět:** Dojedeme za vámi kamkoli, případně se rádi přizpůsobíme online meetingu
  - **Fakturační údaje:** WAVE marketing s.r.o.,IČO: 29524369, DIČ: CZ29524369, U Nádraží 1658, Mníšek pod Brdy, 25210, spisová značka: C 447444 vedená u Městského soudu v Praze
- **Odkazy na sociální sítě:** _Sledujte, jak to u nás žije._ (Odkazy na LinkedIn, Instagram, Facebook). - pokud možno - ikonky IG, FB, Li dát hned nahoru do lišty na úvodní stranu
- **Kontaktní formulář:** Jednoduchý a přátelský.
- _Jméno_
- _E-mail nebo telefon_
- _S čím vám můžeme pomoci?_
- _Tlačítko:_ Odeslat zprávu v lahvi (nebo klasické "Odeslat poptávku").

Co se fotek týče: Můžeme použít nějakou z těchto provizorně a plus samozřejmě vygenerovat odpovídajícímu
